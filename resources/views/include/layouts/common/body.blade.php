...
@if (isDemoMode())
    <div class="fixed bottom-8 start-8 z-50">
        <a class="size-12 inline-flex items-center justify-center rounded-full bg-[#262626] transition-all duration-300 hover:-translate-y-1 hover:scale-110 hover:shadow-md"
            href="https://codecanyon.net/cart/configure_before_adding/37367339"
            target="_blank" title="Buy on Envato">
            <svg fill="#0ac994" xmlns="http://www.w3.org/2000/svg" width="19.824" height="22.629"
